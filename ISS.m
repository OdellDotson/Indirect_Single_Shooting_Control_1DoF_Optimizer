function [x,lambda,u,t] = ISS(L,M,f,r,x_0,T,N,m)
	...
	% options = optimoptions('fsolve','MaxFunEvals',1000,'Algorithm','levenberg-marquardt'); % fked up on Octave
	lambda_0 = fsolve(@(lambda_0)cons(lambda_0,L,M,f,r,x_0,T,N,m),lambda_0); % lambda_0,options);  % see above
